...
import finishedPlacingShips, {
  createRandomShipPlacementButton,
  randomShipPlacement,
...
import {
  draggableFromInside,
  droppableFromInside,
  droppableFromOutside,
  droppableHoverFeedback,
} from "./dragAndDrop";
        ...
        if (preservedCoords.includes(JSON.stringify([rowIndex, columnIndex]))) {
          ...
          if (column && player.isHuman && player === playerPlacingShips) {
            tile.addEventListener("click", (e) =>
              switchShipOrientation(e, player, players, renderGameBoards),
            );
          }
