...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,SAAS;EACT,UAAU;EACV,aAAa;;EAEb,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE;;;;0EAIwE;EACxE,yBAAyB;EACzB,0BAA0B;AAC5B;;AAEA;EACE;;;;;GAKC;EACD,0DAA0D;EAC1D,yBAAyB;AAC3B;;AAEA;;;EAGE,aAAa;AACf;;AAEA;EACE,UAAU;EACV,oBAAoB;AACtB;;AAEA,SAAS;AACT;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;;EAEnB,aAAa;AACf;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;;EAElB,kBAAkB;EAClB,eAAe;EACf,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;;EAET,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;;EAElB,aAAa;EACb,wCAAwC;EACxC,YAAY;AACd;;AAEA;EACE,kDAAkD;AACpD;;AAEA,4BAA4B;AAC5B;EACE,WAAW;EACX,YAAY;;EAEZ,mGAAmG;EACnG;iBACe;AACjB;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;;EAElB,aAAa;EACb,wCAAwC;EACxC,YAAY;AACd;;AAEA,oBAAoB;AACpB;EACE,iBAAiB;;EAEjB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;;EAEE,YAAY;EACZ,iBAAiB;;EAEjB,aAAa;EACb,sCAAsC;EACtC,mCAAmC;AACrC;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,WAAW;EACX,YAAY;;EAEZ;kCACgC;AAClC;;AAEA;EACE;kBACgB;AAClB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;;EAEnB,yBAAyB;EACzB,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA,0BAA0B;AAC1B;EACE,WAAW;;EAEX,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;EACvB,SAAS;AACX;;AAEA;EACE,WAAW;EACX,uBAAuB;EACvB,yBAAyB;;EAEzB,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;EACzB,yBAAyB;AAC3B;;AAEA,eAAe;AACf;EACE,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,YAAY;;EAEZ,aAAa;AACf;;AAEA;EACE,WAAW;;EAEX,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,yBAAyB;EACzB,yBAAyB;AAC3B;;AAEA,oBAAoB;AACpB;EACE,YAAY;EACZ,iBAAiB;EACjB,aAAa;EACb,wCAAwC;;EAExC,kBAAkB;EAClB,iBAAiB;EACjB,kBAAkB;EAClB,OAAO;EACP,QAAQ;EACR,kBAAkB;;EAElB,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,mBAAmB;AACrB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;;EAElB,aAAa;EACb,wCAAwC;EACxC,YAAY;AACd;;AAEA;EACE,mCAAmC;AACrC","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&display=swap\");\n\n* {\n  font-family: \"IBM Plex Mono\", monospace;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  height: 100vh;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.menu-background {\n  background:\n    radial-gradient(black 15%, transparent 16%) 0 0,\n    radial-gradient(black 15%, transparent 16%) 8px 8px,\n    radial-gradient(rgba(255, 255, 255, 0.1) 15%, transparent 20%) 0 1px,\n    radial-gradient(rgba(255, 255, 255, 0.1) 15%, transparent 20%) 8px 9px;\n  background-color: #282828;\n  background-size: 16px 16px;\n}\n\n.game-background {\n  background: linear-gradient(\n    0deg,\n    rgba(194, 178, 128, 1) 0%,\n    rgba(194, 178, 128, 1) 0%,\n    rgba(35, 137, 218, 1) 20%\n  );\n  box-shadow: inset 0px 0px 23px 12px rgba(194, 178, 128, 1);\n  border: 2px inset #c2b280;\n}\n\n.removed,\n.battleship-container.removed,\n.gameover-modal.removed {\n  display: none;\n}\n\n.hidden {\n  opacity: 0;\n  pointer-events: none;\n}\n\n/* Menu */\n.game-menu-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  padding: 25px;\n}\n\n.game-title-container {\n  font-weight: 700;\n  font-style: normal;\n\n  text-align: center;\n  font-size: 72px;\n  color: #c0c0c0;\n}\n\n.game-mode-container {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n\n  max-width: 250px;\n}\n\n.game-mode-container button {\n  font-weight: 700;\n  font-style: normal;\n\n  padding: 10px;\n  background-color: rgba(194, 178, 128, 1);\n  color: black;\n}\n\n.game-mode-container button:hover {\n  box-shadow: 0px 0px 5px 4px rgba(194, 178, 128, 1);\n}\n\n/* Battleship Game Buttons */\n.random-ship-placement {\n  width: 35px;\n  height: 35px;\n\n  /* filter: invert(81%) sepia(0%) saturate(94%) hue-rotate(134deg) brightness(93%) contrast(101%); */\n  filter: invert(78%) sepia(15%) saturate(728%) hue-rotate(8deg) brightness(90%)\n    contrast(89%);\n}\n\n.ready-up {\n  font-weight: 700;\n  font-style: normal;\n\n  padding: 10px;\n  background-color: rgba(194, 178, 128, 1);\n  color: black;\n}\n\n/* Battleship Game */\n.battleship-container {\n  max-width: 1200px;\n\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 10px;\n}\n\n.player-boards {\n  display: flex;\n  justify-content: space-between;\n}\n\n.player1-board,\n.player2-board {\n  width: 500px;\n  min-height: 500px;\n\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n  grid-template-rows: repeat(10, 1fr);\n}\n\n.tile {\n  border: 1px solid #a8b0b2;\n}\n\n.tile.valid-placement {\n  background-color: #99a3a3;\n}\n\n.tile.ship {\n  background-color: #070809;\n}\n\n.tile.hit {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.tile.hit.sunk {\n  background-color: #dc143c;\n}\n\n.tile.hit img {\n  width: 100%;\n  height: 100%;\n\n  filter: invert(18%) sepia(48%) saturate(5244%) hue-rotate(335deg)\n    brightness(95%) contrast(104%);\n}\n\n.tile.hit.sunk img {\n  filter: invert(7%) sepia(4%) saturate(596%) hue-rotate(170deg) brightness(89%)\n    contrast(107%);\n}\n\n.tile.missed {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  background-color: #a8b0b2;\n  opacity: 0.5;\n}\n\n.tile.missed img {\n  width: 100%;\n  height: 100%;\n}\n\n/* Ship pieces container */\n.draggable-ships-container {\n  width: 50px;\n\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 10px;\n}\n\n.ship-container {\n  width: 25px;\n  border: 1px solid white;\n  background-color: #070809;\n\n  display: flex;\n  flex-direction: column;\n}\n\n.ship-body {\n  min-height: 25px;\n  border: 1px solid #a8b0b2;\n  background-color: #070809;\n}\n\n/* Ghost Ship */\n#ghost-ship {\n  position: absolute;\n  top: -1000px;\n}\n\n.horizontal {\n  height: 25px;\n\n  display: flex;\n}\n\n.vertical {\n  width: 25px;\n\n  display: flex;\n  flex-direction: column;\n}\n\n.ghost-ship-body {\n  height: 100%;\n  width: 100%;\n  border: 1px solid #a8b0b2;\n  background-color: #070809;\n}\n\n/* Game Over Modal */\n.gameover-modal {\n  width: 300px;\n  min-height: 100px;\n  padding: 15px;\n  background-color: rgba(194, 178, 128, 1);\n\n  position: absolute;\n  margin-left: auto;\n  margin-right: auto;\n  left: 0;\n  right: 0;\n  text-align: center;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  align-items: center;\n}\n\n.gameover-modal .winner-name {\n  font-size: 32px;\n}\n\n.gameover-modal button {\n  font-weight: 700;\n  font-style: normal;\n\n  padding: 10px;\n  background-color: rgba(194, 178, 128, 1);\n  color: black;\n}\n\n.gameover-modal button:hover {\n  box-shadow: 0px 0px 5px 4px #c0c0cc;\n}\n"],"sourceRoot":""}]);
// Exports
      ...
      row.forEach((column, columnIndex) => {
        if (preservedCoords.includes(JSON.stringify([rowIndex, columnIndex]))) {
          ...
          if (
            ...
            (0,_dragAndDrop__WEBPACK_IMPORTED_MODULE_1__.droppableFromInside)(
              tile,
              dragData,
              player,
              players,
          ...
          if (
            ...
            if (dragData.origin === "insideBoard") {
              ...
              (0,_dragAndDrop__WEBPACK_IMPORTED_MODULE_1__.droppableFromOutside)(
                tile,
                dragData,
                player,
                players,
          ...
          if (column && player.isHuman && player === playerPlacingShips) {
            tile.addEventListener("click", (e) =>
              (0,_placeShips__WEBPACK_IMPORTED_MODULE_0__.switchShipOrientation)(e, player, players, renderGameBoards),
            );
          }
  ...
  [5, 4, 3, 3, 2].forEach((length) => {
    ...
    while (
      !player.board.placeShip(
        (0,_ship__WEBPACK_IMPORTED_MODULE_1__["default"])(length, randomOrientation),
