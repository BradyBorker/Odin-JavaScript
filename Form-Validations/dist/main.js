...
form label {
    display: flex;
    flex-direction: column;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,0BAA0B;IAC1B,SAAS;AACb;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B","sourcesContent":["body {\n    height: 100vh;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n}\n\nform {\n    width: 500px;\n    display: grid;\n    grid-template-columns: 1fr;\n    gap: 10px;\n}\n\nform label {\n    display: flex;\n    flex-direction: column;\n}"],"sourceRoot":""}]);
// Exports
